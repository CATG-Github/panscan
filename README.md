...
For a detailed description on how to run this module ,its required inputs and the files produced by it please check out the **[detailed tutorial page](https://github.com/CATG-Github/panscan/blob/main/complex_tutorial.md)**.
...
- A locus with **≥5 haplotypes (alleles)**
- Containing at least **one ≥10 kb structural variant (SV)**
...
This module identifies **unique variants** — including **SNPs**, **InDels**, and **SVs** — in the input Pangenome VCF by comparing them against public databases such as **dbSNP**, **gnomAD**, **1000 Genomes**, **GME**, **HGSVC** and **DGV**.
...
#### **Variant Types**
- `-t SNP` → Identify unique **single-nucleotide polymorphisms**
- `-t INDEL` → Identify unique **insertions and deletions**
- `-t SV` → Identify unique **structural variants**
